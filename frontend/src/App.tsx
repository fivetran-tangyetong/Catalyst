...
import { MantineProvider, ColorSchemeProvider, ColorScheme, AppShell, Loader, Center } from '@mantine/core';
          ...
          <AuthProvider>
            <Routes>
              <Route path="/login" element={
                <LoginPage onLogin={() => {
                  const auth = document.querySelector('[data-auth-context]') as HTMLElement;
                  if (auth) {
                    const authContext = (auth as any).__authContext as AuthContextType;
                    authContext.login();
                  }
                }} />
              } />
